			...
			<div class="content_scene_cat">
				...
				{else}
                    ...
                    <div class="content_scene_cat_bg">
                        <img height="{$categorySize.height}px;" width="{$categorySize.width}px;" id="categoryImage" title="Mobiles" alt="Mobiles" src="{$link->getCatImageLink($category->link_rewrite, $category->id_image, 'category_default')|escape:'html':'UTF-8'}">
                     </div>
					 {/if}
					 {if $category->description}
						<div class="cat_desc">
