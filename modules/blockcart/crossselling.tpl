	...
	<section class="page-product-box ttcrossselling">
		...
		{/foreach}
			...
			<div class="block_content">
				<ul id="ttcartcrossselling-carousel" class="tt-carousel product_grid grid clearfix">
					{foreach from=$orderProducts item='orderProduct' name=orderProduct}
		...
		{if $tt_total > 4}
			<div class="customNavigation">
				<a class="btn prev ttcartcrossselling_prev">{l s='Prev' mod='crossselling'}</a>
				<a class="btn next ttcartcrossselling_next">{l s='Next' mod='crossselling'}</a>
			</div>
		{/if}
	</section>
{/if}