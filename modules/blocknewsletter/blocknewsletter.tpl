...
<div id="newsletter_block_left" class="block footer-block col-sm-3">
	<div class="ttnewsletter-div container">
		<div class="ttnewsletter-border">
			<div class="ttnewsletter-desc">
				
					<h4>{l s='Newsletter' mod='blocknewsletter'}</h4>
	
				<div class="block_content toggle-footer">
				<p class="ttdesc">{l s='Claritas processus dynamicus sequitu processus dynamicus sequitu.' mod='blocknewsletter'}</p>
