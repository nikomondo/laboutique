...
<div class="breadcrumb clearfix">
	...
	{if $page_name =='product'}
		<h4 class="ttbreadcrumb-product">{$product->name|escape:'html':'UTF-8'}</h4>
	{elseif $page_name =='category'}
		<h4 class="ttbreadcrumb-category">{$category->name|escape:'html':'UTF-8'}</h4>
	{elseif $page_name =='module-smartblog-category'}
		<h4 class="ttbreadcrumb-blogcategory">{$meta_title|escape:'html':'UTF-8'}</h4>
	{elseif $page_name =='module-smartblog-details'}
		<h4 class="ttbreadcrumb-blogpage">{$meta_title|escape:'html':'UTF-8'}</h4>
	{else}	
		<h4 class="ttbreadcrumb-page">{$path}</h4>
	{/if}
